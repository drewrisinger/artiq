...
* :func:`~artiq.tools.verbosity_args` renamed to :func:`~artiq.tools.add_common_args`. 
  New feature: adds an option to print the ARTIQ version (``--version``) through 
  :func:`~artiq.tools.add_common_args`.
